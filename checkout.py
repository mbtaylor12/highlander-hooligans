...
def pop_waiting(db, cus_num):
    ...
    try:
        ...
        c.execute("INSERT INTO past SELECT * FROM out WHERE name = '" + str(cus_num) +"'")
        c.execute("DELETE FROM out WHERE name = '" + str(cus_num) +"'")
        db.commit()
    except Error as e:
        print(e)
...
def pop_help(db, cus_num):
    ...
    try:
        ...
        c.execute("INSERT INTO out SELECT * FROM checkoutHardware WHERE name = '" + str(cus_num) +"'")
        db.commit()
    except Error as e:
        print(e)
