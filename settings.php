<?php
   ...
   if(($_SESSION['idlevel'] != 'admin')){header('Location: index.php');}
...
<html>
     ...
     <div id="centerContent">    <!-- creates center content div -->
		...
		<form  action='addHardware.php' method='post' name='insert'>
            ...
            <?php 
                        ...
                        echo "<option value='$class' name='submitclass'>$class</option>";
                            }
                        echo " </select><br><br>";
                    ?>
 ...
 <div id="inputRight">
		...
		<form action='createAccount.php' method='post' name='insert'>
			...
			<br />
            <?php 
                        $jsonString = exec('python users.py -s permissions -all');
                        $cards = jsonTo2DArray($jsonString);
            
                        echo "<br><b>Permission:<b>
